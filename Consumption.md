...
This solution leverages Azure Logic Apps in the **Consumption** pricing model. It is designed to streamline and automate processes through three workflows. Additionally, a user-managed identity is employed to securely grant access to necessary resources, ensuring seamless integration and enhanced security.For Standard model, please refer to the [README](./readme.md) file.
